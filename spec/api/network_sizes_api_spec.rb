...
# Unit tests for VericredClient::NetworkSizesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetworkSizesApi' do
  before do
    # run before each test
    @instance = VericredClient::NetworkSizesApi.new
  end
  ...
  describe 'test an instance of NetworkSizesApi' do
    it 'should create an instact of NetworkSizesApi' do
      expect(@instance).to be_instance_of(VericredClient::NetworkSizesApi)
    end
  end

  # unit tests for list_state_network_sizes
  # State Network Sizes
