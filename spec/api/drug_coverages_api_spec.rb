...
# Unit tests for VericredClient::DrugCoveragesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DrugCoveragesApi' do
  before do
    # run before each test
    @instance = VericredClient::DrugCoveragesApi.new
  end
  ...
  describe 'test an instance of DrugCoveragesApi' do
    it 'should create an instact of DrugCoveragesApi' do
      expect(@instance).to be_instance_of(VericredClient::DrugCoveragesApi)
    end
  end
