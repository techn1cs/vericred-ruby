...
# Unit tests for VericredClient::DrugPackagesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DrugPackagesApi' do
  before do
    # run before each test
    @instance = VericredClient::DrugPackagesApi.new
  end
  ...
  describe 'test an instance of DrugPackagesApi' do
    it 'should create an instact of DrugPackagesApi' do
      expect(@instance).to be_instance_of(VericredClient::DrugPackagesApi)
    end
  end
