...
# Unit tests for VericredClient::ZipCountyBulk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZipCountyBulk' do
  before do
    # run before each test
    @instance = VericredClient::ZipCountyBulk.new
  end
  ...
  describe 'test an instance of ZipCountyBulk' do
    it 'should create an instact of ZipCountyBulk' do
      expect(@instance).to be_instance_of(VericredClient::ZipCountyBulk)
    end
  end
