...
# Unit tests for VericredClient::DrugSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DrugSearchResponse' do
  before do
    # run before each test
    @instance = VericredClient::DrugSearchResponse.new
  end
  ...
  describe 'test an instance of DrugSearchResponse' do
    it 'should create an instact of DrugSearchResponse' do
      expect(@instance).to be_instance_of(VericredClient::DrugSearchResponse)
    end
  end
