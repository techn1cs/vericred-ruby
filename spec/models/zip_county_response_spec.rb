...
# Unit tests for VericredClient::ZipCountyResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZipCountyResponse' do
  before do
    # run before each test
    @instance = VericredClient::ZipCountyResponse.new
  end
  ...
  describe 'test an instance of ZipCountyResponse' do
    it 'should create an instact of ZipCountyResponse' do
      expect(@instance).to be_instance_of(VericredClient::ZipCountyResponse)
    end
  end
  ...
  describe 'test attribute "zip_county"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
