...
# Unit tests for VericredClient::PlanZipCounty
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanZipCounty' do
  before do
    # run before each test
    @instance = VericredClient::PlanZipCounty.new
  end
  ...
  describe 'test an instance of PlanZipCounty' do
    it 'should create an instact of PlanZipCounty' do
      expect(@instance).to be_instance_of(VericredClient::PlanZipCounty)
    end
  end
