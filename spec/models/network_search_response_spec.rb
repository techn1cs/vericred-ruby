...
# Unit tests for VericredClient::NetworkSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetworkSearchResponse' do
  before do
    # run before each test
    @instance = VericredClient::NetworkSearchResponse.new
  end
  ...
  describe 'test an instance of NetworkSearchResponse' do
    it 'should create an instact of NetworkSearchResponse' do
      expect(@instance).to be_instance_of(VericredClient::NetworkSearchResponse)
    end
  end
