...
# Unit tests for VericredClient::DrugPackage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DrugPackage' do
  before do
    # run before each test
    @instance = VericredClient::DrugPackage.new
  end
  ...
  describe 'test an instance of DrugPackage' do
    it 'should create an instact of DrugPackage' do
      expect(@instance).to be_instance_of(VericredClient::DrugPackage)
    end
  end
