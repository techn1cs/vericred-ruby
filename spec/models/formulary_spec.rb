...
# Unit tests for VericredClient::Formulary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Formulary' do
  before do
    # run before each test
    @instance = VericredClient::Formulary.new
  end
  ...
  describe 'test an instance of Formulary' do
    it 'should create an instact of Formulary' do
      expect(@instance).to be_instance_of(VericredClient::Formulary)
    end
  end
