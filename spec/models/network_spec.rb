...
# Unit tests for VericredClient::Network
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Network' do
  before do
    # run before each test
    @instance = VericredClient::Network.new
  end
  ...
  describe 'test an instance of Network' do
    it 'should create an instact of Network' do
      expect(@instance).to be_instance_of(VericredClient::Network)
    end
  end
