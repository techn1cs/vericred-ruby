...
# Unit tests for VericredClient::RequestPlanFind
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestPlanFind' do
  before do
    # run before each test
    @instance = VericredClient::RequestPlanFind.new
  end
  ...
  describe 'test an instance of RequestPlanFind' do
    it 'should create an instact of RequestPlanFind' do
      expect(@instance).to be_instance_of(VericredClient::RequestPlanFind)
    end
  end
