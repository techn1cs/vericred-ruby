...
describe 'PlanSearchResult' do
  ...
  describe 'test an instance of PlanSearchResult' do
    it 'should create an instact of PlanSearchResult' do
      expect(@instance).to be_instance_of(VericredClient::PlanSearchResult)
    end
  end
  ...
  describe 'test attribute "employee_premium"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dependent_premium"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
