...
# Unit tests for VericredClient::ProviderGeocode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProviderGeocode' do
  before do
    # run before each test
    @instance = VericredClient::ProviderGeocode.new
  end
  ...
  describe 'test an instance of ProviderGeocode' do
    it 'should create an instact of ProviderGeocode' do
      expect(@instance).to be_instance_of(VericredClient::ProviderGeocode)
    end
  end
