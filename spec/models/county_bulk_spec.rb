...
# Unit tests for VericredClient::CountyBulk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CountyBulk' do
  before do
    # run before each test
    @instance = VericredClient::CountyBulk.new
  end
  ...
  describe 'test an instance of CountyBulk' do
    it 'should create an instact of CountyBulk' do
      expect(@instance).to be_instance_of(VericredClient::CountyBulk)
    end
  end
