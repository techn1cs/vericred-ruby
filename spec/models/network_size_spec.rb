...
# Unit tests for VericredClient::NetworkSize
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetworkSize' do
  before do
    # run before each test
    @instance = VericredClient::NetworkSize.new
  end
  ...
  describe 'test an instance of NetworkSize' do
    it 'should create an instact of NetworkSize' do
      expect(@instance).to be_instance_of(VericredClient::NetworkSize)
    end
  end
