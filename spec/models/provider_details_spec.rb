...
# Unit tests for VericredClient::ProviderDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProviderDetails' do
  before do
    # run before each test
    @instance = VericredClient::ProviderDetails.new
  end
  ...
  describe 'test an instance of ProviderDetails' do
    it 'should create an instact of ProviderDetails' do
      expect(@instance).to be_instance_of(VericredClient::ProviderDetails)
    end
  end
