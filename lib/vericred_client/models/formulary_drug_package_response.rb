...
module VericredClient
  ...
  class FormularyDrugPackageResponse
    # DrugCoverage
    attr_accessor :coverage

    # DrugPackage
    attr_accessor :drug_package

    # Formulary
    attr_accessor :formulary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'coverage')
        self.coverage = attributes[:'coverage']
      end

      if attributes.has_key?(:'drug_package')
        self.drug_package = attributes[:'drug_package']
      end

      if attributes.has_key?(:'formulary')
        self.formulary = attributes[:'formulary']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          coverage == o.coverage &&
          drug_package == o.drug_package &&
          formulary == o.formulary
    end
    ...
    def hash
      [coverage, drug_package, formulary].hash
    end
