...
module VericredClient
  ...
  class FormularyResponse
    # Meta-data
    attr_accessor :meta

    # List of formularies.
    attr_accessor :formularies
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'formularies')
        if (value = attributes[:'formularies']).is_a?(Array)
          self.formularies = value
        end
      end
