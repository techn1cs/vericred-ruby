...
module VericredClient
  ...
  class StateNetworkSizeResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'network_sizes')
        if (value = attributes[:'network_sizes']).is_a?(Array)
          self.network_sizes = value
        end
      end
