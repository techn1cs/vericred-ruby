...
module VericredClient
  class DrugCoveragesApi
    ...
    def get_drug_coverages_with_http_info(ndc_package_code, audience, state_code, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'ndc_package_code' when calling DrugCoveragesApi.get_drug_coverages" if ndc_package_code.nil?
      # verify the required parameter 'audience' is set
      fail ArgumentError, "Missing the required parameter 'audience' when calling DrugCoveragesApi.get_drug_coverages" if audience.nil?
      # verify the required parameter 'state_code' is set
      fail ArgumentError, "Missing the required parameter 'state_code' when calling DrugCoveragesApi.get_drug_coverages" if state_code.nil?
      # resource path
