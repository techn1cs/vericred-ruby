...
module VericredClient
  class NetworkSizesApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [StateNetworkSizeResponse]
    def search_network_sizes(body, opts = {})
      data, _status_code, _headers = search_network_sizes_with_http_info(body, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(StateNetworkSizeResponse, Fixnum, Hash)>] StateNetworkSizeResponse data, response status code and response headers
    def search_network_sizes_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NetworkSizesApi.search_network_sizes ..."
      end
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling NetworkSizesApi.search_network_sizes" if body.nil?
      # resource path
      local_var_path = "/network_sizes/search".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'StateNetworkSizeResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkSizesApi#search_network_sizes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
